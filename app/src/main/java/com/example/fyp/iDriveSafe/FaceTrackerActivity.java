...
import com.example.fyp.iDriveSafe.ui.camera.CameraSourcePreview;
import com.example.fyp.iDriveSafe.ui.camera.GraphicOverlay;
...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private String key_2 = "WAQAS's project";
    ...
    public void onCreate(Bundle icicle) {
        ...
        end_button.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                Intent next = new Intent(FaceTrackerActivity.this, com.example.fyp.iDriveSafe.end.class);
                count=0;
                count1=0;
        ...
        handlerData.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent i = new Intent(FaceTrackerActivity.this, MainActivity.class);
                i.putExtra("flipcamera2", "1");
                startActivity(i);
            }
        }, 10000);
    }
...
//            mCameraSource.release();
    ...
    private class GraphicFaceTracker extends Tracker<Face> {
        ...
        private com.example.fyp.iDriveSafe.FaceGraphic mFaceGraphic;

        GraphicFaceTracker(GraphicOverlay overlay) {
            mOverlay = overlay;
            mFaceGraphic = new com.example.fyp.iDriveSafe.FaceGraphic(overlay);
        }
