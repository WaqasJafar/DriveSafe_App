 ...
 */
public final class FaceTrackerActivity2 extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        end_button.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                Intent next = new Intent(FaceTrackerActivity2.this, com.example.fyp.iDriveSafe.end.class);
                count=0;
                count1=0;
                ...
                startActivity(next);
                FaceTrackerActivity2.this.finish();
                return false;
            }
        });
    ...
    {   play_media();
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                play_media();
                AlertDialog dig;
                dig = new AlertDialog.Builder(FaceTrackerActivity2.this)
